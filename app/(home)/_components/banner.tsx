...
const Banner = () => {
  return (
    <header className="grid place-items-center items-center gap-4 min-h-[450px] overflow-hidden">
      <div className="text-center grid place-items-center gap-4">
        <h1 className="text-5xl text-center w-[60%]">
          Hire .NET Developers: Affordable, Dedicated .NET Experts in 72 hours
        </h1>

        <h2 className="text-center text-xl w-[60%]">
